...
document);
(function(b,d){function a(a){this.viewport=a;this.parent=a.parentNode;this.initialize()}var p={27:"hide",38:"previous",40:"next",84:"toggle"};a.prototype.initialize=function(){this.content=this.viewport.getElementsByTagName("article");this.initFrame().initNav();b.addEventListener("resize",this.redraw.bind(this));b.addEventListener("keydown",this.hotkeys.bind(this))};a.prototype.setAttributes=Atomic.prototype.setAttributes;a.prototype.redraw=function(a){this.frame.style.height=this.parent.offsetHeight+"px";
this.frame.style.width=this.parent.offsetWidth+"px"};a.prototype.initFrame=function(){var a=this.frame=d.createElement("iframe");this.setAttributes(a,{seamless:!0,height:this.parent.offsetHeight+"px",width:this.parent.offsetWidth+"px",src:this.viewport.getAttribute("data-load")});this.viewport.insertBefore(a,this.viewport.firstChild);return this};a.prototype.initNav=function(){for(var a=["<input type=text value=0 readonly><ol>","</ol><canvas></canvas>"],c=this.setAttributes(d.createElement("section"),
...
(this.index=0);this.atomic.radio[this.index].checked=!0};a.prototype.next=function(){++this.index>this.max&&(this.index=this.max);this.atomic.radio[this.index].checked=!0};a.prototype.toggle=function(){this["hide"===this.nav.getAttribute("class")?"show":"hide"].call(this)};a.prototype.hide=function(){this.nav.setAttribute("class","hide");this.viewport.setAttribute("class","dawn hide")};a.prototype.show=function(){this.nav.setAttribute("class","show");this.viewport.setAttribute("class","dawn show")};
a.prototype.hotkeys=function(a){(a=p[a.keyCode])&&this[a].call(this)};a.instance=new a(document.getElementsByClassName("dawn")[0]);b.Dawn=a})(window,document);