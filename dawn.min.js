...
function(a){this.frame.style.height=this.parent.offsetHeight+"px";this.frame.style.width=this.parent.offsetWidth+"px"};a.prototype.initFrame=function(){var a=this.frame=f.createElement("iframe");this.setAttributes(a,{seamless:!0,height:this.parent.offsetHeight+"px",width:this.parent.offsetWidth+"px",src:this.viewport.getAttribute("data-load")});this.viewport.insertBefore(a,this.viewport.firstChild);return this};a.prototype.initNav=function(){for(var a=["<input type=text value=0 readonly><ol>","</ol><canvas></canvas>"],
